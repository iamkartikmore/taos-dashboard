    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-800">
          <p className="text-[11px] text-slate-600">Changes are saved to GitHub and apply immediately.</p>
          <div className="flex gap-2">
...
function UsersTab({ brands }) {
  ...
  return (
    <>
      ...
      <div className="mt-4 p-3 rounded-lg bg-emerald-900/20 border border-emerald-700/30 flex items-start gap-2 text-xs text-emerald-300">
        <Check size={13} className="shrink-0 mt-0.5"/>
        Changes are saved to GitHub and persist permanently across all restarts and deploys.
      </div>
    </>
  );
}
